...
Ecpected result:
The user is redirected to the product page and all products are displayed with name, image, price
...
## TC006 Verify product can be removed from cart
Requirement: REQ-006
...
## TC007 Verify cart page loads correctly
Requirement: REQ-007
...
Expected result:
The Checkout Information page is displayed with First Name, Last Name and Postal Code
...
## TC012 Verify checkout validation error messages
Requirement: REQ-012
...
## TC013 Verify checkout validation error messages
Requirement: REQ-012
